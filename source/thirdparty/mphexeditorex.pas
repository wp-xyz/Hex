...
type
  ...
  public
    ...
    procedure BeforeDestruction; override;
    function GetData(const formatetcIn: TagFormatEtc; out medium: TagStgMedium):
      HResult; stdcall;
    ...
    try
      ...
      begin
        ...
        begin
          ...
          case LWrdCurrent of
            Windows.CF_TEXT: LStrFormatName := STR_CF_TEXT;
            Windows.CF_BITMAP: LStrFormatName := STR_CF_BITMAP;
            Windows.CF_METAFILEPICT: LStrFormatName := STR_CF_METAFILEPICT;
...
function TMPHDropTarget.DragLeave: HResult; stdcall;
begin
  Result := S_OK;
...
function TMPHEnumFormatETC.Clone(out Enum: IEnumFormatEtc): HResult; stdcall;
begin
...
function TMPHEnumFormatETC.Reset: HResult; stdcall;
begin
  FIndex := 0;
  Result := S_OK;
end;
...
function TMPHDataObject.GetData(const formatetcIn: TagFormatEtc; out
  medium: TagStgMedium): HResult; stdcall;
var
...
function TMPHDataObject.GetDataHere(const formatetc: TFormatEtc; out
  medium: TStgMedium): HResult; stdcall;
begin
